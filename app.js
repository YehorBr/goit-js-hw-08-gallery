const galleryItems = [
  ...
  const closeModalButtonRef = document.querySelector('.lightbox__button')
  const modalIconRef = document.querySelector('.lightbox__image')

  function createGalleryMarkUp(icons){
